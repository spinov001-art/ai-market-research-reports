...
**What you get:**
- Market overview with TAM/SAM/SOM estimates
- 10+ latest news articles with analysis
- Competitor landscape (GitHub stars, funding, features)
- Community sentiment (HN, Reddit, Stack Overflow)
- Academic papers and tech trends
...
All reports are in the [reports/](./reports/) folder. Click any file to view.

### Industries Covered

| Category | Example Topics |
|----------|---------------|
| **AI/ML** | GPT competitors, computer vision, NLP, MLOps, AI agents |
| **SaaS** | CRM, project management, analytics, communication tools |
